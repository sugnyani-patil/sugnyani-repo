...
df_users_final= df_users.withColumnRenamed("id", "emp_id").withColumn("ingestion_date", current_timestamp()).withColumn("full_name", concat("name", lit(" "), "last_name")).drop("is_customer", "name", "last_name")
